...
public class BaseClass {
	...
	public static Properties prop;
		...
		public void browserLaunch()
		{
			...
			driver.manage().timeouts().pageLoadTimeout(ActionClass.PAGE_LOAD_TIMEOUT, TimeUnit.SECONDS);
			driver.manage().timeouts().implicitlyWait(ActionClass.IMPLICIT_WAIT, TimeUnit.SECONDS);
